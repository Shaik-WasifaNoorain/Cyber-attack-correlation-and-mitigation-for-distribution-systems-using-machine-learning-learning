"""cyberattack_correlationURL Configuration
...
urlpatterns = [
    ...
    url(r'^Predict_Cyberattack_Status/$', remoteuser.Predict_Cyberattack_Status, name="Predict_Cyberattack_Status"),
    ...
    url(r'^Find_Prediction_Of_Cyberattack_Status_Ratio/$', serviceprovider.Find_Prediction_Of_Cyberattack_Status_Ratio, name="Find_Prediction_Of_Cyberattack_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Cyberattack_Status/$', serviceprovider.View_Prediction_Of_Cyberattack_Status, name="View_Prediction_Of_Cyberattack_Status"),
